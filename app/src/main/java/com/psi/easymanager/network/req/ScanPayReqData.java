...
import com.psi.easymanager.pay.wxpay.Configure;
import com.psi.easymanager.pay.wxpay.RandomStringGenerator;
import com.psi.easymanager.pay.wxpay.Signature;
...
public class ScanPayReqData implements Serializable {
    ...
    //每个字段具体的意思请查看API文档
    @Expose private String appid = "";
    @Expose private String mch_id = "";
    @Expose private String device_info = "";
    @Expose private String nonce_str = "";
    @Expose private String sign = "";
    @Expose private String body = "";
    @Expose private String attach = "";
    @Expose private String out_trade_no = "";
    @Expose private int total_fee = 0;
    @Expose private String spbill_create_ip = "";
    @Expose private String time_start = "";
    @Expose private String time_expire = "";
    @Expose private String goods_tag = "";
    @Expose private String auth_code = "";

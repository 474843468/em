...
/** 
 * DAO for table "DiscounScheme".
*/
public class PxDiscounSchemeDao extends AbstractDao<PxDiscounScheme, Long> {

    public static final String TABLENAME = "DiscounScheme";

    /**
     * Properties of entity PxDiscounScheme.<br/>
    ...
    */
    ...
    public PxDiscounSchemeDao(DaoConfig config) {
        super(config);
    }
    
    public PxDiscounSchemeDao(DaoConfig config, DaoSession daoSession) {
    ...
    public static void createTable(SQLiteDatabase db, boolean ifNotExists) {
        ...
        db.execSQL("CREATE TABLE " + constraint + "\"DiscounScheme\" (" + //
    ...
    public static void dropTable(SQLiteDatabase db, boolean ifExists) {
        String sql = "DROP TABLE " + (ifExists ? "IF EXISTS " : "") + "\"DiscounScheme\"";
        db.execSQL(sql);
    }

    /** @inheritdoc */
    @Override
    protected void bindValues(SQLiteStatement stmt, PxDiscounScheme entity) {
        stmt.clearBindings();
    ...
    /** @inheritdoc */
    @Override
    public PxDiscounScheme readEntity(Cursor cursor, int offset) {
        PxDiscounScheme entity = new PxDiscounScheme( //
    ...
    /** @inheritdoc */
    @Override
    public void readEntity(Cursor cursor, PxDiscounScheme entity, int offset) {
    ...
    /** @inheritdoc */
    @Override
    protected Long updateKeyAfterInsert(PxDiscounScheme entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    ...
    /** @inheritdoc */
    @Override
    public Long getKey(PxDiscounScheme entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;

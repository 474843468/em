 ...
 * 桌台信息
 */
public class PxTableInfo implements java.io.Serializable {
    ...
    @Expose private long duration;//持续时间(用于收银端向服务生发送桌台信息)
    @Expose private int actualPeopleNumber;//实际用餐人数(用于收银端向服务生发送桌台信息)
    // KEEP FIELDS END

...
public class ScanGunKeyEventUtils {
  ...
  private StringBuilder mStringBufferResult;                  //扫码内容
  ...
  public ScanGunKeyEventUtils(OnScanSuccessListener onScanSuccessListener) {
   ...
   */
  @Deprecated public boolean isScanGunEvent(KeyEvent event) {
